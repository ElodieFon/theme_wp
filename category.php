...
<div class="d-flex justify-content-between w-100">
    ...
    <div class="posts d-flex flex-wrap justify-content-evenly ">

        <h1 class="text-center mb-5 col-12"><?= get_the_archive_title();?></h1>

        <div class="pagination d-flex align-items-center justify-content-center flex-row col-12">
        ...
        <?php if(have_posts()): 
            while(have_posts()): the_post(); ?>
                <article class="col-3 d-flex flex-wrap ">
